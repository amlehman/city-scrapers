...
from city_scrapers.spiders.il_housing_development import IlHousingDevelopmentSpider

test_response = file_response(
    join(dirname(__file__), "files", "il_housing_development.html"),
    url="https://www.ihda.org/about-ihda/public-meetings-and-notices/",
)
spider = IlHousingDevelopmentSpider()
